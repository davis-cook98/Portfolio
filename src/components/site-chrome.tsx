...
export function SiteChrome({ children }: { children: React.ReactNode }) {
  return (
    <div className="mx-auto flex w-full flex-col px-6 py-8 sm:px-10 lg:min-h-dvh lg:px-16 lg:py-10 xl:px-24">
      ...
      <div className="py-4 lg:py-6">
        <DrawablyDivider className="m-0" />
      </div>

      <main className="flex flex-col lg:flex-1">{children}</main>

      <div className="pt-4 pb-3 lg:py-6">
        <DrawablyDivider className="m-0" />
      </div>
